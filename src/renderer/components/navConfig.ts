...
export function buildNav(phase: DashboardView['phase']): NavItem[] {
  ...
  return [
    ...
    { id: 'staff', label: 'Staff', icon: 'staff', section: 'development', screen: 'personnel', match: ['personnel', 'jobMarket'],
      subTabs: [{ id: 'personnel', label: 'Staff' }, { id: 'jobMarket', label: 'Job Market' }] },
    ...
    { id: 'dev', label: 'Dev. Center', icon: 'devCenter', section: 'development', screen: 'teamDevelopment', match: ['teamDevelopment', 'mentorship'],
      subTabs: [{ id: 'teamDevelopment', label: 'Development' }, { id: 'mentorship', label: 'Mentorship' }] },
