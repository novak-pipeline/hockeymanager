...
export interface GamePlayerStat {
   ...
   * power-play goals don't count). Skaters only; 0 for goalies; see
   * `creditPlusMinus`. Optional — absent on stats serialized before this
   * field was added; treat missing as 0.
   */
  plusMinus?: number
}
