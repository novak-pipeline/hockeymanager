...
const HEADLINE_POOL: Record<CoachSituation, DemeanorPool | string[]> = {
  ...
  postWin: [
    `"We did the job" — Coach on the {opp} win`,
...
const QUOTE_POOL: Record<CoachSituation, DemeanorPool> = {
  ...
  /* ═══════════ postWin (any ordinary win — the nightly receipt) ═══════════ */
  postWin: {
    fiery: [
      "We earned that one the hard way. Every inch of it. That's the kind of win that builds a team's spine.",
      "I liked our push when it mattered. When the game asked a question tonight, we answered with our fists up.",
      "{opp} came to play and we still took it. Good. I want wins where the other guys leave sore.",
      "That third period is who we are. Keep the boot on the throat and the scoreboard takes care of itself.",
      "Two points, and we took them — nobody handed us anything tonight. That's how I want every night to feel.",
      "We won the battles that decide hockey games. The wall, the net-front, the slot. Everything else is decoration.",
      "I saw guys finishing checks in the last four minutes of a game we already had. That tells me more than the score does.",
      "Did we play a perfect game? No. Did we out-want them? Yes. I'll take that trade every night of the week.",
      "{opp} tried to slow it down and drag us into their game. We refused. You have to refuse, or you become them.",
      "Somebody's got to set the temperature in a building and tonight it was us. Keep doing that and this becomes a hard place to visit.",
    ],
    calm: [
      "A professional night's work. We managed the game well and closed it out properly.",
      "Pleased with the composure. {opp} pushed and we didn't blink — that's a sign of maturity.",
      "The details held up: line changes, coverage, puck management. Quiet things win games like that one.",
      "We took what the game gave us tonight. Not every win is pretty; this one was earned sensibly.",
      "A solid sixty minutes. We'll bank the points, review the shifts we didn't like, and move along.",
      "I thought we deserved it on balance. The stretches we controlled were the stretches that decided it.",
      "There was a stretch in the second where we could have opened it up and chose to be patient instead. That's growth.",
      "We defended a lead without retreating into our own end. That's a harder skill than it sounds, and we did it well.",
      "Nothing in that game surprised me — which is exactly what you want. Prepared teams get boring results like this one.",
      "The bench was calm the whole way. When the group doesn't panic, the game usually comes to you.",
    ],
    analytical: [
      "We tilted the ice when it mattered — our zone time in the deciding stretch was excellent.",
      "The chances ledger favored us tonight, and for once the scoreboard agreed with it.",
      "Structurally sound. We forced {opp} to the outside all night and the danger against stayed low.",
      "Winning the special-teams minutes decided this one — look at where the momentum shifted.",
      "Our forecheck created the turnovers, the turnovers created the goals. Clean cause and effect tonight.",
      "The score flatters nobody — it was a one-battle game and we won that battle more often.",
      "We conceded almost nothing from the inside. Hold that number down and you win a lot of hockey games.",
      "Our entries were controlled instead of dumped, and you can see it in how long we held the puck in their end.",
      "Faceoff percentage was the quiet story. Starting with the puck changes every read that follows.",
      "Two of our goals came off recoveries below the dots — that's the pattern we've been drilling. It's showing up now.",
    ],
    motivator: [
      "Proud of the group tonight. Someone different steps up every night — that's becoming our identity.",
      "Wins like this are the bricks. Not the highlight-reel nights — these. The team that shows up and does it.",
      "The bench was alive all night. When they pull for each other like that, we're hard to beat.",
      "We talked before the game about trusting each other in the hard minutes. You saw the answer out there.",
      "That room believes right now, and belief compounds. Enjoy tonight, then bring it to the next one.",
      "Every guy on that sheet gave us something. You win in this league twenty men at a time.",
      "The fourth line set the tone and the top guys followed them. That's the order I want it in.",
      "I watched our young guys handle a tight third period without flinching. That's the part I'll remember.",
      "We've asked a lot of this group lately and they keep answering. At some point you stop being surprised and start expecting it.",
      "The best sound in hockey is twenty guys on the bench standing up at once. Heard it twice tonight.",
    ],
    pragmatic: [
      "We got the two points. That's the job. On to the next one.",
      "A win's a win. Some things to clean up, but I'd rather correct after a W than an L.",
      "Good result. The tape will show plenty to fix — winning just makes the meeting shorter.",
      "{opp} gave us trouble in stretches. We survived them, we scored our goals, we move on.",
      "The league table doesn't ask how. Two points, next game.",
      "We did enough, and some nights enough is exactly what's required. Recovery starts now.",
      "I'm not going to oversell a regular-season win in {opp}. We were competent. Competent gets points.",
      "You bank these in the fall so you're not begging for them in the spring. That's the whole philosophy.",
      "Nothing about tonight changes our plan. That's the point of having one.",
      "Two points and no injuries. By my standards that's an excellent evening.",
    ],
  },

  /* ═══════════ postLoss (any ordinary loss — the nightly receipt) ═══════════ */
  postLoss: {
    fiery: [
      "That one stings and it should. We had it there to take and we let it slide. I won't pretend otherwise.",
      "Not enough. Not for sixty minutes. Pockets of good hockey don't beat anybody in this league.",
      "We lost the hard areas tonight and you don't deserve points when you lose the hard areas. Simple.",
      "I'm not interested in close. {opp} wanted it more in the moments that decide games. That's on all of us.",
      "The response better come Thursday. I've said my piece in the room — now I want to see it on the ice.",
      "One shift. One shift where we fall asleep and the game turns. That can't keep being our story.",
      "We got outmuscled in front of our own net and I refuse to call that bad luck. That's a choice, and it was the wrong one.",
      "I don't want to hear about effort. Effort is the price of admission. We needed execution and we didn't have it.",
      "They wanted the puck more than we did in the third. Say what you like about systems — that part is character.",
      "Nobody in that room should sleep well tonight. Including me.",
    ],
    calm: [
      "A tight game that went their way. We'll look at the two or three moments that tipped it.",
      "Not much between the teams tonight. The margins went to {opp}; our job is to earn them back next game.",
      "I saw plenty to like and a few things to fix. We'll be measured about it — no panic over one night.",
      "We didn't get the bounce, and we didn't quite force it either. That second part is what we control.",
      "Credit {opp}, they executed late. We'll take the lesson and keep building.",
      "These games come down to detail, and tonight the detail wasn't quite ours. It's correctable.",
      "I won't be making sweeping statements after one night. We'll watch it properly and decide properly.",
      "We had our chances and didn't take them. That's the game — you don't get to keep the ones you missed.",
      "Their goalie was good. Ours was fine. The difference was in the details around both nets.",
      "The group stayed with it, which matters. Now we need the result to follow the performance.",
    ],
    analytical: [
      "The game was decided in a five-minute stretch — our coverage broke twice and that's the story.",
      "We generated enough to win; the finishing wasn't there. The process I can live with, the result no.",
      "Look at where their goals came from — the middle of our ice. That's the whole review right there.",
      "Our exits under pressure failed us tonight. Fix the first pass and most of what went wrong disappears.",
      "{opp} won the special-teams exchange and in a one-goal game that IS the game.",
      "The shot map says close; the goal map says they got the slot and we didn't. That gap is the work.",
      "We lost the neutral zone. Every goal against started with a clean entry we should have denied at the line.",
      "Our second-chance defending was poor — we won the first save and lost every rebound that mattered.",
      "Faceoffs in our own end were a problem all night, and it put us on our heels for entire shifts.",
      "I can defend the volume we generated. I can't defend where we generated it from.",
    ],
    motivator: [
      "I told the group: nights like this are information, not identity. We answer in the next one.",
      "Nobody hangs their head in that room. We were in it to the end and the effort was honest.",
      "One result doesn't shake what we're building. The response is where character shows — watch us.",
      "We fell short tonight, together. And together is exactly how we'll put it right.",
      "The margins were thin and they'll be thin again. Next time they fall our way — because we'll make them.",
      "I still like this group's fight. Keep the belief, sharpen the details, and this flips.",
      "I'd rather lose a game like that than win one where we learned nothing. Small comfort, but it's true.",
      "The young guys got a lesson tonight that no video session can give them. They'll be better for it.",
      "We're not far away. I'd be lying if I said otherwise, and this room knows when I'm lying.",
      "Heads up in there. The season's long and this group has more to say.",
    ],
    pragmatic: [
      "They got the points tonight. It happens. We correct and move on.",
      "A loss, not a crisis. There are eighty-two of these; the response matters more than the result.",
      "We'll take the tape, mark the mistakes, and fix them. That's the whole speech.",
      "{opp} did their job better than we did ours tonight. Tomorrow we get back to work.",
      "No dramatics. A couple of moments cost us; a couple of corrections get us back.",
      "The schedule gives us a quick chance to make this a footnote. Let's use it.",
      "You're going to lose thirty-odd games a year. The question is only whether you lose them in clusters.",
      "I've got no complaints about the officiating, the bounces, or the schedule. We were second best. Next.",
      "Video in the morning, practice after. Same as it would have been if we'd won.",
      "One point, no points — either way the standings are decided in March, not tonight.",
    ],
  },
