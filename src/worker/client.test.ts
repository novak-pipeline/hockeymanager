...
describe('SimClient', () => {
  ...
  it('maps every method to its protocol message', () => {
    ...
    const calls: Array<[() => Promise<WorkerResponse>, Record<string, unknown>]> = [
      ...
      [() => client.getWaiverWire(), { type: 'getWaiverWire' }],
      [() => client.claimWaiver('p9'), { type: 'claimWaiver', playerId: 'p9' }],
      [() => client.getLeagueWire(), { type: 'getLeagueWire' }],
      ...
      [() => client.getMentorships(), { type: 'getMentorships' }],
      [() => client.assignMentor('m1', 'v1'), { type: 'assignMentor', menteeId: 'm1', mentorId: 'v1' }],
      [() => client.clearMentor('m1'), { type: 'clearMentor', menteeId: 'm1' }],
      [() => client.getClubDirection(), { type: 'getClubDirection' }],
